...
public class Maps implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? Maps.Deleted.IS_DELETED.value() : Maps.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = Maps.Deleted.IS_DELETED.value();
        NOT_DELETED = Maps.Deleted.NOT_DELETED.value();
    }
    ...
    public static enum Column {
        ...
        public static Maps.Column[] excludes(Maps.Column... excludes) {
            ArrayList<Maps.Column> columns = new ArrayList(Arrays.asList(values()));
