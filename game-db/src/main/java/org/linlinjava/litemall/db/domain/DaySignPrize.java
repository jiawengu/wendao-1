...
public class DaySignPrize implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? DaySignPrize.Deleted.IS_DELETED.value() : DaySignPrize.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = DaySignPrize.Deleted.IS_DELETED.value();
        NOT_DELETED = DaySignPrize.Deleted.NOT_DELETED.value();
    }
    ...
    public static enum Column {
        ...
        public static DaySignPrize.Column[] excludes(DaySignPrize.Column... excludes) {
            ArrayList<DaySignPrize.Column> columns = new ArrayList(Arrays.asList(values()));
            if (excludes != null && excludes.length > 0) {
                columns.removeAll(new ArrayList(Arrays.asList(excludes)));
            }

            return (DaySignPrize.Column[])columns.toArray(new DaySignPrize.Column[0]);
        }
