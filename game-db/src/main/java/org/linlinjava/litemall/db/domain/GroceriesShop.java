...
public class GroceriesShop implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? GroceriesShop.Deleted.IS_DELETED.value() : GroceriesShop.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = GroceriesShop.Deleted.IS_DELETED.value();
        NOT_DELETED = GroceriesShop.Deleted.NOT_DELETED.value();
    }
    ...
    public static enum Column {
        ...
        public static GroceriesShop.Column[] excludes(GroceriesShop.Column... excludes) {
            ArrayList<GroceriesShop.Column> columns = new ArrayList(Arrays.asList(values()));
            if (excludes != null && excludes.length > 0) {
                columns.removeAll(new ArrayList(Arrays.asList(excludes)));
            }

            return (GroceriesShop.Column[])columns.toArray(new GroceriesShop.Column[0]);
        }
