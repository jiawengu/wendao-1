...
public class Experience implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? Experience.Deleted.IS_DELETED.value() : Experience.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = Experience.Deleted.IS_DELETED.value();
        NOT_DELETED = Experience.Deleted.NOT_DELETED.value();
    }
    ...
    public static enum Column {
        ...
        public static Experience.Column[] excludes(Experience.Column... excludes) {
            ArrayList<Experience.Column> columns = new ArrayList(Arrays.asList(values()));
