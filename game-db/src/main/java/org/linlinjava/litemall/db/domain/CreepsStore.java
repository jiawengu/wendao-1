...
public class CreepsStore implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? CreepsStore.Deleted.IS_DELETED.value() : CreepsStore.Deleted.NOT_DELETED.value());
    }
    ...
    public boolean equals(Object that) {
        if (this == that) {
            ...
            boolean var10000;
            label80: {
                CreepsStore other = (CreepsStore)that;
                if (this.getId() == null) {
                    if (other.getId() != null) {
                        break label80;
                    }
    ...
    public CreepsStore clone() throws CloneNotSupportedException {
        return (CreepsStore)super.clone();
    }

    static {
        IS_DELETED = CreepsStore.Deleted.IS_DELETED.value();
        NOT_DELETED = CreepsStore.Deleted.NOT_DELETED.value();
    }
    ...
    public static enum Column {
        ...
        public static CreepsStore.Column[] excludes(CreepsStore.Column... excludes) {
            ArrayList<CreepsStore.Column> columns = new ArrayList(Arrays.asList(values()));
            if (excludes != null && excludes.length > 0) {
                columns.removeAll(new ArrayList(Arrays.asList(excludes)));
            }

            return (CreepsStore.Column[])columns.toArray(new CreepsStore.Column[0]);
        }
