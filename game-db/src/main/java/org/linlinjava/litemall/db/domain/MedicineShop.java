...
public class MedicineShop implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? MedicineShop.Deleted.IS_DELETED.value() : MedicineShop.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = MedicineShop.Deleted.IS_DELETED.value();
        NOT_DELETED = MedicineShop.Deleted.NOT_DELETED.value();
    }
    ...
    public static enum Column {
        ...
        public static MedicineShop.Column[] excludes(MedicineShop.Column... excludes) {
            ArrayList<MedicineShop.Column> columns = new ArrayList(Arrays.asList(values()));
