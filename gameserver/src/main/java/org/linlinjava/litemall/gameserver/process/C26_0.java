...
/*  37 */         GameObjectCharMng.getGameObjectChar(((Vo_4121_0)gameTeam.zhanliduiyuan.get(i)).id).sendOne(new MSG_NOTIFY_MISC(), vo_20480_0);
...
/*  72 */       GameObjectChar.send(new MSG_NOTIFY_MISC(), vo_20480_0);
...
/* 102 */         GameObjectCharMng.getGameObjectChar(((Chara)duiwu.get(i)).id).sendOne(new MSG_NOTIFY_MISC(), vo_20480_0);
/*     */         
/*     */ 
