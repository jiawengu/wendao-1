...
/*  60 */       GameObjectCharMng.getGameObjectChar(chara1.id).sendOne(new MSG_DIALOG(), vo_20467_1);
...
/*  71 */       GameObjectCharMng.getGameObjectChar(chara1.id).sendOne(new MSG_CONFIRM(), vo_45240_0);
...
/* 119 */         GameObjectCharMng.getGameObjectChar(id).sendOne(new MSG_DIALOG(), vo_20467_0);
/* 120 */         vo_8165_0 = new Vo_8165_0();
/* 121 */         vo_8165_0.msg = "有人申请组队，请查看";
/* 122 */         vo_8165_0.active = 0;
/* 123 */         GameObjectCharMng.getGameObjectChar(id).sendOne(new MSG_DIALOG_OK(), vo_8165_0);
/* 124 */         return;
/*     */       }
/*     */       
/* 127 */       Vo_61593_0 vo_61593_0 = new Vo_61593_0();
/* 128 */       vo_61593_0.ask_type = "invite_join";
/* 129 */       GameObjectChar.send(new MSG_CLEAN_ALL_REQUEST(), vo_61593_0);
/*     */       
/*     */ 
...
/* 145 */       GameUtil.MSG_UPDATE_TEAM_LIST(duiwu);
/* 146 */       GameUtil.MSG_UPDATE_TEAM_LIST_EX(GameObjectChar.getGameObjectChar().gameTeam.zhanliduiyuan);
/* 147 */       Vo_20568_0 vo_20568_0 = new Vo_20568_0();
/* 148 */       vo_20568_0.gid = "";
/* 149 */       GameObjectChar.send(new MSG_TEAM_COMMANDER_GID(), vo_20568_0);
/*     */       
/*     */ 
...
/* 163 */         GameObjectChar.send(new MSG_CLEAN_ALL_REQUEST(), vo_61593_0);
/*     */         
/*     */ 
...
/* 179 */         GameUtil.MSG_UPDATE_TEAM_LIST(duiwu);
/* 180 */         GameUtil.MSG_UPDATE_TEAM_LIST_EX(GameObjectChar.getGameObjectChar().gameTeam.zhanliduiyuan);
/* 181 */         Vo_20568_0 vo_20568_0 = new Vo_20568_0();
/* 182 */         vo_20568_0.gid = "";
/* 183 */         GameObjectChar.send(new MSG_TEAM_COMMANDER_GID(), vo_20568_0);
/*     */         
/*     */ 
...
/*     */ 
/*     */ 
/* 197 */       List<Vo_61545_0> vo_61545_0List = GameUtil.MSG_FRIEND_ADD_CHAR(chara1);
...
/* 204 */       GameObjectChar.send(new MSG_DIALOG_OK(), vo_8165_0);
/*     */       
/*     */ 
...
/* 212 */       GameObjectCharMng.getGameObjectChar(id).sendOne(new MSG_DIALOG_OK(), vo_8165_0);
/*     */     }
/*     */   }
/*     */   
/*     */ 
