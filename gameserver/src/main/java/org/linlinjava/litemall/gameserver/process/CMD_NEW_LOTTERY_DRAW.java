...
/* 127 */       ((PetShuXing)petbeibao.petShuXing.get(0)).enchant = 0;
/* 128 */       ((PetShuXing)petbeibao.petShuXing.get(0)).enchant_nimbus = 0;
/* 129 */       ((PetShuXing)petbeibao.petShuXing.get(0)).mount_type = 1;
/* 130 */       ((PetShuXing)petbeibao.petShuXing.get(0)).capacity_level = jieshu;
/* 131 */       PetShuXing shuXing = new PetShuXing();
/* 132 */       shuXing.no = 23;
/* 133 */       shuXing.type1 = 2;
/* 134 */       shuXing.phy_power = (4 * (jieshu - 1));
/* 135 */       shuXing.mag_power = (4 * (jieshu - 1));
/* 136 */       shuXing.def = (3 * (jieshu - 1));
/* 137 */       shuXing.all_attrib = 0;
/* 138 */       shuXing.upgrade_immortal = 0;
/* 139 */       shuXing.upgrade_magic = 0;
