...
public class GameUtil {
    public static void addshouhu(Chara chara) {
        for (int i = 0; i < chara.listshouhu.size(); i++) {
            org.linlinjava.litemall.gameserver.domain.ShouHu shouHu = (org.linlinjava.litemall.gameserver.domain.ShouHu) chara.listshouhu
                    .get(i);
            org.linlinjava.litemall.gameserver.domain.ShouHuShuXing shouHuShuXing = (org.linlinjava.litemall.gameserver.domain.ShouHuShuXing) ((org.linlinjava.litemall.gameserver.domain.ShouHu) chara.listshouhu
                    .get(i)).listShouHuShuXing.get(0);
            java.util.Hashtable<String, int[]> stringHashtable = org.linlinjava.litemall.gameserver.data.game.PetAttributesUtils
                    .helpPet(shouHuShuXing.penetrate, shouHuShuXing.metal, chara.level);
            ...
            int[] ints = org.linlinjava.litemall.gameserver.data.game.BasicAttributesUtils.calculationHelpAttributes(
                    chara.level, attributes[0], attributes[1], attributes[2], attributes[3], polars[0], polars[1],
                    polars[2], polars[3], polars[4], shouHuShuXing.metal);
    ...
    public static void addfabaojingyan(Chara chara1, int jingyan) {
        ...
        if (has.booleanValue()) {
            ...
            GameObjectCharMng.getGameObjectChar(chara1.id)
                    .sendOne(new org.linlinjava.litemall.gameserver.data.write.M20481_0(), vo_20481_0);
        }
    }
    ...
    public static Boolean fabaojingyan(Chara chara1, int jingyan) {
        ...
        for (int i = 0; i < chara1.backpack.size(); i++) {
            if (((Goods) chara1.backpack.get(i)).pos == 9) {
                ...
                GameObjectCharMng.getGameObjectChar(chara1.id)
                        .sendOne(new org.linlinjava.litemall.gameserver.data.write.M65525_0(), list);
                if (((Goods) chara1.backpack.get(i)).goodsInfo.pot >= ((Goods) chara1.backpack
                        .get(i)).goodsInfo.resist_poison) {
                    ...
                    ((Goods) chara1.backpack
                            .get(i)).goodsInfo.resist_poison = GameData.that.baseExperienceTreasureService
                                    .findOneByAttrib(Integer.valueOf(((Goods) chara1.backpack.get(i)).goodsInfo.skill))
    ...
    public static void nextshaxing(Chara chara1, Chara duiyuan, int level, String replace) {
        ...
        if (replace.equals("天星")) {
            ...
            ListVo_65527_0 localListVo_65527_01 = a65527(duiyuan);
        }
    ...
    public static void shidaojingyan(Chara chara1, Chara duiyuan, int id) {
        ...
        GameObjectChar.getGameObjectChar().gameMap.send(new org.linlinjava.litemall.gameserver.data.write.M12285_1(),
                Integer.valueOf(id));
        ...
        for (int i = 0; i < duiyuan.pets.size(); i++) {
            if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                ...
                int base_pet_dh = (int) (0.29D * petShuXing.skill * petShuXing.skill * petShuXing.skill);
                int intimacy = 33 * petShuXing.skill
                        / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1);
                petShuXing.intimacy += intimacy;
                org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
    ...
    public static void nextxuanshang(Chara chara1, Chara duiyuan) {
        ...
        GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M12285_1(),
                Integer.valueOf(
                        ((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcxuanshang.get(0)).id),
                chara1.id);
        ...
        for (int i = 0; i < duiyuan.pets.size(); i++) {
            if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                PetShuXing petShuXing = (PetShuXing) ((Petbeibao) duiyuan.pets.get(i)).petShuXing.get(0);
                int base_pet_dh = (int) (0.29D * petShuXing.skill * petShuXing.skill * petShuXing.skill);
                int intimacy = 29 * petShuXing.skill
                        / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1);
                petShuXing.intimacy += intimacy;
                org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
    ...
    public static boolean duiwudengji(Chara chara, GameObjectChar session) {
        ...
        for (int i = 0; i < session.gameTeam.duiwu.size() - 1; i++) {
            if (Math.abs(((Chara) session.gameTeam.duiwu.get(i)).level
                    - ((Chara) session.gameTeam.duiwu.get(i + 1)).level) > 10) {
                hasyes = false;
            }
        }
        return hasyes;
    ...
    public static void adddaohang(Chara chara, int daohangdian) {
        ...
        vo_20481_0.time = ((int) (System.currentTimeMillis() / 1000L));
        GameObjectCharMng.getGameObjectChar(chara.id)
                .sendOne(new org.linlinjava.litemall.gameserver.data.write.M20481_0(), vo_20481_0);
    }
    ...
    public static void nextshuadao(Chara chara1, Chara duiyuan) {
        ...
        duiyuan.shuadao += 1;
        GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M12285_1(),
                Integer.valueOf(((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcshuadao.get(0)).id),
                chara1.id);
        ...
        if (duiyuan.shuadao <= 400) {
            ...
            int owner_name = (int) (39 * duiyuan.level * (1.0D + 0.2D * chubao)
                    / (duiyuan.friend > base_dh ? duiyuan.friend / base_dh : 1) * beishu) * 15;
            ...
            for (int i = 0; i < duiyuan.pets.size(); i++) {
                if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                    ...
                    int intimacy = (int) (22 * petShuXing.skill * (1.0D + 0.2D * chubao)
    ...
    public static void chubaorenwu(Chara chara1, Chara duiyuan) {
        ...
        duiyuan.chubao += 1;
        List<org.linlinjava.litemall.db.domain.RenwuMonster> all = GameData.that.baseRenwuMonsterService
                .findByType(Integer.valueOf(1));

        int k = random.nextInt(all.size());
        org.linlinjava.litemall.db.domain.RenwuMonster renwuMonster = (org.linlinjava.litemall.db.domain.RenwuMonster) all
                .get(k);
        ...
        GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M12285_1(),
                Integer.valueOf(((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcchubao.get(0)).id),
                chara1.id);
        ...
        if (duiyuan.chubao < 21) {
            ...
            int owner_name = (int) (39 * duiyuan.level * (1.0D + 0.2D * chubao)
                    / (duiyuan.friend > base_dh ? duiyuan.friend / base_dh : 1));
            adddaohang(duiyuan, owner_name);
            ...
            for (int i = 0; i < duiyuan.pets.size(); i++) {
                if (((Petbeibao) duiyuan.pets.get(i)).id == duiyuan.chongwuchanzhanId) {
                    PetShuXing petShuXing = (PetShuXing) ((Petbeibao) duiyuan.pets.get(i)).petShuXing.get(0);
                    int base_pet_dh = (int) (0.29D * petShuXing.skill * petShuXing.skill * petShuXing.skill);
                    int intimacy = (int) (13 * petShuXing.skill * (1.0D + 0.2D * chubao)
                            / (petShuXing.intimacy > base_pet_dh ? petShuXing.intimacy / base_pet_dh : 1));
                    petShuXing.intimacy += intimacy;
                    org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0 vo_20481_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_20481_0();
                    vo_20481_0.msg = ("宠物获得武学#R" + intimacy);
        ...
        if (chara1.mapid == ((org.linlinjava.litemall.gameserver.data.vo.Vo_65529_0) chara1.npcchubao.get(0)).mapid) {
            GameObjectChar.sendduiwu(new org.linlinjava.litemall.gameserver.data.write.M65529_0(),
                    chara1.npcchubao.get(0), chara1.id);
        }
    ...
    public static void chenghaoxiaoxi(Chara chara) {
        ...
        GameObjectCharMng.getGameObjectChar(chara.id)
                .sendOne(new org.linlinjava.litemall.gameserver.data.write.M62209_0(), list);
    }
    ...
    public static void shuafabao(Chara chara) {
        ...
        if (info.getSilverCoin() != null) {
            goods.goodsInfo.silver_coin = info.getSilverCoin().intValue();
        }
        goods.goodsInfo.type = info.getType().intValue();
        goods.goodsInfo.attrib = 0;
        goods.goodsInfo.shape = 0;
        goods.goodsInfo.str = info.getName();
        goods.goodsInfo.nick = 0;
        goods.goodsInfo.recognize_recognized = info.getRecognizeRecognized().intValue();
        goods.goodsInfo.auto_fight = java.util.UUID.randomUUID().toString();
        goods.goodsInfo.total_score = info.getTotalScore().intValue();
        goods.goodsInfo.rebuild_level = 50000;
        goods.goodsInfo.value = info.getValue().intValue();
    ...
    public static void weijianding(Chara chara) {
        ...
        List<java.util.Hashtable<String, Integer>> hashtables = equipmentLuckDraw(chara.level, leixing);
    ...
    public static void renwujiangli(Chara chara) {
        org.linlinjava.litemall.db.domain.Renwu renwu = GameData.that.baseRenwuService
    ...
    public static String nextrenw(String str) {
        ...
        org.linlinjava.litemall.db.domain.Renwu serviceOneByCurrentTask = GameData.that.baseRenwuService
                .findOneByCurrentTask(renwu);
    ...
    public static void addVip(Chara chara) {
        ...
        GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M53257_0(), vo_53257_0);
    }
        ...
        for (int i = 0; i < chara.backpack.size(); i++) {
            if (((Goods) chara.backpack.get(i)).pos == 37) {
                ...
                GameObjectChar.getGameObjectChar().gameMap
                        .send(new org.linlinjava.litemall.gameserver.data.write.M65529_0(), vo_65529_0);
            }
        }
    }
    ...
    public static void addpetjingyan(Petbeibao petbeibao, int jingyan, Chara chara) {
        ...
        if (petShuXing.pot >= 2000000000) {
            petShuXing.pot = 2000000000;
        }

        if ((petShuXing.pot >= petShuXing.resist_poison) && (petShuXing.skill < 125)) {
            petShuXing.pot -= petShuXing.resist_poison;
            petShuXing.skill += 1;
            org.linlinjava.litemall.db.domain.Experience oneByMaxLevel = GameData.that.baseExperienceService
                    .findOneByAttrib(Integer.valueOf(petShuXing.skill));
            ...
            if (((PetShuXing) petbeibao.petShuXing.get(0)).suit_light_effect != 0) {
                for (int i = 0; i < petbeibao.petShuXing.size(); i++) {
                    if (((PetShuXing) petbeibao.petShuXing.get(i)).no == 23) {
                        ((PetShuXing) petbeibao.petShuXing.get(i)).accurate = (4
                                * (((PetShuXing) petbeibao.petShuXing.get(0)).hide_mount - 1)
                                * ((PetShuXing) petbeibao.petShuXing.get(0)).skill);
                        ((PetShuXing) petbeibao.petShuXing.get(i)).mana = (4
                                * (((PetShuXing) petbeibao.petShuXing.get(0)).hide_mount - 1)
                                * ((PetShuXing) petbeibao.petShuXing.get(0)).skill);
                        ((PetShuXing) petbeibao.petShuXing.get(i)).wiz = (3
                                * (((PetShuXing) petbeibao.petShuXing.get(0)).hide_mount - 1)
                                * ((PetShuXing) petbeibao.petShuXing.get(0)).skill);
                    }
                }
            ...
            List list = new ArrayList();
            boolean isfagong = ((PetShuXing) petbeibao.petShuXing.get(0)).rank > ((PetShuXing) petbeibao.petShuXing
                    .get(0)).pet_mag_shape;
            dujineng(1, ((PetShuXing) petbeibao.petShuXing.get(0)).metal,
                    ((PetShuXing) petbeibao.petShuXing.get(0)).skill, isfagong, petbeibao.id, chara);
            list.add(petbeibao);
            GameObjectCharMng.getGameObjectChar(chara.id)
                    .sendOne(new org.linlinjava.litemall.gameserver.data.write.M65507_0(), list);
        }
        List list = new ArrayList();
        list.add(petbeibao);
        GameObjectCharMng.getGameObjectChar(chara.id)
    ...
    public static void addjingyan(Chara chara, int jingyan) {
        ...
        if ((chara.pot >= chara.resist_poison) && (chara.level < 128)) {
            ...
            chara.level += 1;
            org.linlinjava.litemall.db.domain.Experience oneByMaxLevel = GameData.that.baseExperienceService
                    .findOneByAttrib(Integer.valueOf(chara.level));
    ...
    public static void cangkuaddwupin(Goods goods, Chara chara) {
        ...
        for (int i = 0; i < chara.cangku.size(); i++) {
            ...
            java.util.Map<Object, Object> objectMapGoodxin = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                    .GoodsInfo(goods.goodsInfo);
            java.util.Map<Object, Object> objectMapGoodxin1 = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                    .GoodsLanSe(goods1.goodsLanSe);

            objectMapGoodxin.remove("auto_fight");
            objectMapGoodxin.remove("owner_id");
            java.util.Map<Object, Object> objectMapGoodjold = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                    .GoodsInfo(goods1.goodsInfo);
            java.util.Map<Object, Object> objectMapGoodjold1 = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                    .GoodsLanSe(goods1.goodsLanSe);
            ...
            if ((objectMapGoodjold.toString().equals(objectMapGoodxin.toString()))
                    && (objectMapGoodxin1.toString().equals(objectMapGoodjold1.toString()))
                    && (goods1.goodsInfo.degree_32 == 1)) {
        ...
        if (has) {
            ...
            if (goods.goodsInfo.owner_id > munber) {
                ...
                for (int i = 0; i < len; i++) {
                    java.util.Map<Object, Object> objectMapGoodxin = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                            .Goods(goods);
                    Goods goodsxin = (Goods) org.linlinjava.litemall.db.util.JSONUtils.parseObject(
                            org.linlinjava.litemall.db.util.JSONUtils.toJSONString(objectMapGoodxin), Goods.class);
            ...
            if ((objectMapGoodjold.toString().equals(objectMapGoodxin.toString()))
                ...
                if (goods1.goodsInfo.owner_id < munber) {
                    ...
                    if (goods1.goodsInfo.owner_id >= munber) {
                        ...
                        GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M65525_0(),
                                chara.backpack);
                        has = false;
                    }
                }
    ...
    public static org.linlinjava.litemall.gameserver.data.vo.Vo_49179_0 a49179(
            List<org.linlinjava.litemall.db.domain.SaleGood> saleGoodList, Chara chara) {
        ...
        for (int i = 0; i < saleGoodList.size(); i++) {
            ...
            org.linlinjava.litemall.db.domain.SaleGood saleGood = (org.linlinjava.litemall.db.domain.SaleGood) saleGoodList
                    .get(i);
            ...
            if (saleGood.getName().contains("超级黑水晶·")) {
                ...
                java.util.Map<Object, Object> goodsFenSe1 = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                        .GoodsLanSe(goods1.goodsLanSe);
                int value = 0;
    ...
    public static void a49159(Chara chara) {
        ...
        for (int j = 0; j < chara.shenmiliwu.size(); j++) {
            if (!((org.linlinjava.litemall.gameserver.data.vo.Vo_41480_0) chara.shenmiliwu.get(j)).name.equals("")) {
                vo_49159_3.leftTime += ((org.linlinjava.litemall.gameserver.data.vo.Vo_41480_0) chara.shenmiliwu
                        .get(j)).time;
            }
        }
        for (int i = 0; i < chara.shenmiliwu.size(); i++) {
            if (((org.linlinjava.litemall.gameserver.data.vo.Vo_41480_0) chara.shenmiliwu.get(i)).name.equals("")) {
                ...
                vo_49159_3.leftTime = ((int) (vo_49159_3.leftTime
    ...
    public static List<JiNeng> dujineng(int leixing, int pos, int level, boolean isMagic, int id, Chara chara) {
        ...
        List<org.json.JSONObject> nomelSkills = org.linlinjava.litemall.gameserver.data.game.PetAndHelpSkillUtils
                .getNomelSkills(leixing, pos, level, true);
        for (int i = 0; i < nomelSkills.size(); i++) {
            ...
            org.json.JSONObject jsonObject1 = org.linlinjava.litemall.gameserver.data.game.PetAndHelpSkillUtils
                    .jsonArray(jiNeng.skill_no);
        ...
        List<org.linlinjava.litemall.gameserver.data.vo.Vo_32747_0> vo_32747_0List = a32747(jiNengList);
        GameObjectCharMng.getGameObjectChar(chara.id)
                .sendOne(new org.linlinjava.litemall.gameserver.data.write.M32747_0(), vo_32747_0List);
    ...
    public static void a20467(Chara chara, int id, String ask_type) {
        ...
        GameObjectCharMng.getGameObjectChar(id).sendOne(new org.linlinjava.litemall.gameserver.data.write.M20467_0(),
                vo_20467_0);
    }
    ...
    public static void a4121(List<org.linlinjava.litemall.gameserver.data.vo.Vo_4121_0> charaList) {
        ...
        for (org.linlinjava.litemall.gameserver.data.vo.Vo_4121_0 vo41210 : charaList) {
            GameObjectCharMng.getGameObjectChar(vo41210.id)
                    .sendOne(new org.linlinjava.litemall.gameserver.data.write.M4121_0(), vo_4121_0List);
        }
    }
    ...
    public static void a4119(List<Chara> charaList) {
        ...
        for (int i = 0; i < chara1.listshouhu.size(); i++) {
            if (((org.linlinjava.litemall.gameserver.domain.ShouHuShuXing) ((org.linlinjava.litemall.gameserver.domain.ShouHu) chara1.listshouhu
                    .get(i)).listShouHuShuXing.get(0)).nil != 0) {
                ...
                vo_45074_0.guardName = ((org.linlinjava.litemall.gameserver.domain.ShouHuShuXing) ((org.linlinjava.litemall.gameserver.domain.ShouHu) chara1.listshouhu
                        .get(i)).listShouHuShuXing.get(0)).str;
                vo_45074_0.guardLevel = chara1.level;
                vo_45074_0.guardIcon = ((org.linlinjava.litemall.gameserver.domain.ShouHuShuXing) ((org.linlinjava.litemall.gameserver.domain.ShouHu) chara1.listshouhu
                        .get(i)).listShouHuShuXing.get(0)).type;
                vo_45074_0.guardOrder = ((org.linlinjava.litemall.gameserver.domain.ShouHuShuXing) ((org.linlinjava.litemall.gameserver.domain.ShouHu) chara1.listshouhu
                        .get(i)).listShouHuShuXing.get(0)).salary;
        ...
        for (Chara chara : charaList) {
            GameObjectCharMng.getGameObjectChar(chara.id)
                    .sendOne(new org.linlinjava.litemall.gameserver.data.write.M45074_0(), list);
            GameObjectCharMng.getGameObjectChar(chara.id)
                    .sendOne(new org.linlinjava.litemall.gameserver.data.write.M4119_0(), vo_4119_0List);
        }
    }

    public static void huodecaifen(Chara chara, org.linlinjava.litemall.db.domain.StoreInfo wupin, int owner_id,
            int leve, int value, String name, Goods goods, int add_pet_exp) {
        List<Goods> list = new ArrayList();
        goods.pos = beibaoweizhi(chara);
        goods.goodsInfo = new GoodsInfo();
    ...
    public static int cangkuweizhi(Chara chara) {
        ...
        for (int i = 0; i < chara.cangku.size(); i++) {
            map.put(Integer.valueOf(((Goods) chara.cangku.get(i)).pos),
                    Integer.valueOf(((Goods) chara.cangku.get(i)).pos));
        }
    ...
    public static int beibaoweizhi(Chara chara) {
        java.util.HashMap<Object, Object> map = new java.util.HashMap();
        for (int i = 0; i < chara.backpack.size(); i++) {
            map.put(Integer.valueOf(((Goods) chara.backpack.get(i)).pos),
                    Integer.valueOf(((Goods) chara.backpack.get(i)).pos));
        }
        int size = 50;
    ...
    public static void zhuangbeiValue(Chara chara) {
        ...
        for (int i = 0; i < chara.backpack.size(); i++) {
            if ((((Goods) chara.backpack.get(i)).pos == 1) || (((Goods) chara.backpack.get(i)).pos == 2)
                    || (((Goods) chara.backpack.get(i)).pos == 3) || (((Goods) chara.backpack.get(i)).pos == 10)) {
                java.util.Map<Object, Object> map = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                        .GoodsLvSeGongMing(((Goods) chara.backpack.get(i)).goodsLvSeGongMing);
                ...
                map = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                        .GoodsGaiZaoGongMing(((Goods) chara.backpack.get(i)).goodsGaiZaoGongMing);
        ...
        if ((taozhuang == 4) && (dengji1 == dengji2) && (dengji2 == dengji3) && (dengji3 == dengji4) && (tao1 == tao2)
                && (tao2 == tao3) && (tao3 == tao4)) {
            int[] suit = org.linlinjava.litemall.gameserver.data.game.SuitEffectUtils.suit(chara.sex - 1, dengji4,
                    chara.menpai, tao1);
        ...
        if ((qianghua == 4) && (dengji1 == dengji2) && (dengji2 == dengji3) && (dengji3 == dengji4)) {
            for (int i = 0; i < chara.backpack.size(); i++) {
                if ((((Goods) chara.backpack.get(i)).pos == 1) || (((Goods) chara.backpack.get(i)).pos == 2)
                    ...
                    java.util.Map<Object, Object> map = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                            .GoodsGaiZaoGongMing(((Goods) chara.backpack.get(i)).goodsGaiZaoGongMing);
                    ((Goods) chara.backpack.get(
                            i)).goodsGaiZaoGongMingChengGong = ((GoodsGaiZaoGongMingChengGong) org.linlinjava.litemall.db.util.JSONUtils
                                    .parseObject(org.linlinjava.litemall.db.util.JSONUtils.toJSONString(map),
        ...
        for (int i = 0; i < chara.backpack.size(); i++) {
            ...
            if (good.goodsFenSe != null) {
                java.util.Map<Object, Object> goodsfense = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                        .GoodsFenSe(good.goodsFenSe);
                for (java.util.Map.Entry<Object, Object> objectObjectEntry : goodsfense.entrySet()) {
                    if ((!objectObjectEntry.getKey().equals("groupNo"))
                            && (!objectObjectEntry.getKey().equals("groupType"))) {
            ...
            if (good.goodsHuangSe != null) {
                java.util.Map<Object, Object> goodshuangse = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                        .GoodsHuangSe(good.goodsHuangSe);
            ...
            if (good.goodsLvSe != null) {
                java.util.Map<Object, Object> goodslvse = org.linlinjava.litemall.gameserver.data.UtilObjMapshuxing
                        .GoodsLvSe(good.goodsLvSe);
            ...
            if ((good.pos <= 10) && (good.pos > 0)) {
                ...
                // System.out.println(good.goodsLanSe.phy_power+" "+good.goodsLanSe.mag_power+"
                // "+good.goodsFenSe.mag_power+" "+good.goodsHuangSe.mag_power+"
                // "+good.goodsFenSe.skill_low_cost+" "+good.goodsLanSe.skill_low_cost+"
                // "+good.goodsHuangSe.skill_low_cost+" skill_low_cost |||||");
                ...
                chara.zbAttribute.life = (chara.zbAttribute.life + good.goodsHuangSe.life
                        + good.goodsHuangSe.all_polar);
            ...
            if (((Petbeibao) chara.pets.get(i)).id == chara.zuoqiId) {
                for (int j = 0; j < ((Petbeibao) chara.pets.get(i)).petShuXing.size(); j++) {
                    if (((PetShuXing) ((Petbeibao) chara.pets.get(i)).petShuXing.get(j)).no == 23) {
                        ...
                        chara.zbAttribute.accurate += ((PetShuXing) ((Petbeibao) chara.pets.get(i)).petShuXing
                                .get(j)).accurate;
        ...
        for (int i = 0; i < chara.jiNengList.size(); i++) {
            if (((JiNeng) chara.jiNengList.get(i)).skill_no == 301) {
                chara.zbAttribute.def += (int) ((chara.zbAttribute.def + chara.def) * 0.01D
                        * ((JiNeng) chara.jiNengList.get(i)).skill_level);
            }

            if (((JiNeng) chara.jiNengList.get(i)).skill_no == 302) {
                chara.zbAttribute.dex += (int) ((chara.zbAttribute.dex + chara.dex) * 0.01D
                        * ((JiNeng) chara.jiNengList.get(i)).skill_level);
            }
        }
    ...
    public static org.linlinjava.litemall.gameserver.data.vo.Vo_61553_0 a61553(
            org.linlinjava.litemall.db.domain.Renwu tasks, Chara chara) {
        if (tasks == null) {
    ...
    public static org.linlinjava.litemall.gameserver.data.vo.Vo_8247_0 a8247(org.linlinjava.litemall.db.domain.Npc npc,
            String content) {
        org.linlinjava.litemall.gameserver.data.vo.Vo_8247_0 vo_8247_0 = new org.linlinjava.litemall.gameserver.data.vo.Vo_8247_0();
        vo_8247_0.id = npc.getId().intValue();
        vo_8247_0.portrait = npc.getIcon().intValue();
        vo_8247_0.pic_no = 1;
    ...
    public static org.linlinjava.litemall.gameserver.data.vo.Vo_65511_0 a65511(Chara chara) {
        ...
        GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M65511_0(), chara.zbAttribute);

        ListVo_65527_0 vo_65527_0 = a65527(chara);
        GameObjectChar.send(new org.linlinjava.litemall.gameserver.data.write.M65527_0(), vo_65527_0);
        org.linlinjava.litemall.gameserver.data.vo.Vo_61661_0 vo_61661_0 = a61661(chara);
    ...
    public static void a49171(Chara chara) {
        ...
        List<String[]> strings = org.linlinjava.litemall.gameserver.data.game.NoviceGiftBagUtils.giftBag(chara.sex,
                chara.menpai);
    ...
    public static void huodechoujiang(String[] strings, Chara chara) {
        ...
        if (strings[1].equals("物品")) {
            org.linlinjava.litemall.db.domain.StoreInfo info = GameData.that.baseStoreInfoService
                    .findOneByName(strings[0]);
        ...
        if (strings[1].equals("装备")) {
            ...
            List<java.util.Hashtable<String, Integer>> hashtables = org.linlinjava.litemall.gameserver.data.game.NoviceGiftBagUtils
                    .equipmentGiftBags(zhuangbeiInfo.getAmount().intValue(), zhuangbeiInfo.getAttrib().intValue());
            if (hashtables.size() > 0) {
                ...
                for (java.util.Hashtable<String, Integer> maps : hashtables) {
                    if (((Integer) maps.get("groupNo")).intValue() == 2) {
                        ...
                        gooodsLanSe = (GoodsLanSe) org.linlinjava.litemall.db.util.JSONUtils.parseObject(
                                org.linlinjava.litemall.db.util.JSONUtils.toJSONString(maps), GoodsLanSe.class);
                    }
                    if (((Integer) maps.get("groupNo")).intValue() == 3) {
                        maps.put("groupType", Integer.valueOf(2));
                        goodsFenSe = (GoodsFenSe) org.linlinjava.litemall.db.util.JSONUtils.parseObject(
                                org.linlinjava.litemall.db.util.JSONUtils.toJSONString(maps), GoodsFenSe.class);
                    }
                    if (((Integer) maps.get("groupNo")).intValue() == 4) {
                        maps.put("groupType", Integer.valueOf(2));
                        goodsHuangSe = (GoodsHuangSe) org.linlinjava.litemall.db.util.JSONUtils.parseObject(
                                org.linlinjava.litemall.db.util.JSONUtils.toJSONString(maps), GoodsHuangSe.class);
                    }
                    if (((Integer) maps.get("groupNo")).intValue() == 10) {
                        gaizao = ((Integer) maps.get("changeNum")).intValue();
                        maps.remove("changeNum");
                        maps.put("groupType", Integer.valueOf(2));
                        goodsGaiZao = (org.linlinjava.litemall.gameserver.domain.GoodsGaiZao) org.linlinjava.litemall.db.util.JSONUtils
                                .parseObject(org.linlinjava.litemall.db.util.JSONUtils.toJSONString(maps),
                                        org.linlinjava.litemall.gameserver.domain.GoodsGaiZao.class);
                    }
                }
                Goods goods = new Goods();
                goods.pos = beibaoweizhi(chara);
    ...
    private static int stageMounts(String name) {
        ...
        String[] mounts_name = { "仙阳剑", "凌岩豹", "幻鹿", "赤焰葫芦", "玉豹", "仙葫芦", "无极熊", "岳麓剑", "古鹿", "北极熊", "筋斗云", "太极熊",
                "墨麒麟" };
    ...
    public static List<java.util.Hashtable<String, Integer>> equipmentLuckDraw(int eq_attrib, int leixing) {
        ...
        List<java.util.Hashtable<String, Integer>> hashtables = org.linlinjava.litemall.gameserver.data.game.ForgingEquipmentUtils
                .appraisalEquipment(leixing, eq_attrib, 10);
    ...
    public static String zhuangbname(Chara chara, int leixing) {
        ...
        for (int j = 0; j < byAttrib.size(); j++) {
            if ((leixing == 1) && (((ZhuangbeiInfo) byAttrib.get(j)).getMetal().intValue() == chara.menpai)
                    && (((ZhuangbeiInfo) byAttrib.get(j)).getAmount().intValue() == leixing)) {
                return ((ZhuangbeiInfo) byAttrib.get(j)).getStr();
            }

            if (((leixing == 2) || (leixing == 3))
                    && (((ZhuangbeiInfo) byAttrib.get(j)).getMaster().intValue() == chara.sex)
                    && (((ZhuangbeiInfo) byAttrib.get(j)).getAmount().intValue() == leixing)) {
                return ((ZhuangbeiInfo) byAttrib.get(j)).getStr();
            }

            if ((leixing == 10) && (((ZhuangbeiInfo) byAttrib.get(j)).getAmount().intValue() == leixing)) {
                return ((ZhuangbeiInfo) byAttrib.get(j)).getStr();
            }
        }
