...
/* 47 */     GameObjectCharMng.sendOne(chara1.id, new MSG_NOTIFY_MISC_EX(), vo_20481_0);
/*    */     
...
/* 51 */       GameObjectCharMng.sendOne(GameObjectChar.getGameObjectChar().gameTeam.duiwu.get(i).id, new MSG_UPDATE_APPEARANCE(), vo_61661_0);
...
/* 56 */         GameObjectCharMng.sendOne(GameObjectChar.getGameObjectChar().gameTeam.duiwu.get(i).id, new MSG_NOTIFY_MISC_EX(), vo_20481_0);
/*    */       } else {
...
/* 71 */     GameObjectCharMng.sendOne(chara1.id, new org.linlinjava.litemall.gameserver.data.write.M49189_0(), vo_49189_0);
/*    */     
/* 73 */     Vo_8165_0 vo_8165_0 = new Vo_8165_0();
/* 74 */     vo_8165_0.msg = "你被请离了队伍";
/* 75 */     vo_8165_0.active = 0;
/* 76 */     GameObjectCharMng.sendOne(chara1.id, new MSG_DIALOG_OK(), vo_8165_0);
/*    */     
