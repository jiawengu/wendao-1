...
/*     */ public class CMD_BUY_FROM_STALL implements org.linlinjava.litemall.gameserver.GameHandler
    ...
    /*     */   {
        ...
        /*  55 */     if (saleGood.getIspet().intValue() == 1) {
            ...
            /*  78 */       vo_40964_11.param = String.valueOf(((PetShuXing)petbeibao.petShuXing.get(0)).icon);
            ...
            /*  89 */       boolean isfagong = ((PetShuXing)petbeibao.petShuXing.get(0)).pet_mag_shape > ((PetShuXing)petbeibao.petShuXing.get(0)).pet_phy_shape;
            /*  90 */       GameUtil.dujineng(1, ((PetShuXing)petbeibao.petShuXing.get(0)).polar, ((PetShuXing)petbeibao.petShuXing.get(0)).level, isfagong, petbeibao.id, chara);
