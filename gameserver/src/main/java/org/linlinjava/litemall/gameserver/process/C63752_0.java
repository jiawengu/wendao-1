...
import org.linlinjava.litemall.gameserver.data.write.M12023_0;
import org.linlinjava.litemall.gameserver.data.write.M12023_1;
    ...
    public void process(ChannelHandlerContext ctx, ByteBuf buff) {
        ...
        if (50006 == type) {
            ...
            switch (chara.vipType) {
                case 1:
                    TitleService.grantTitle(chara, TitleConst.TITLE_YUEKA, "位列仙班·灵识初开");
                    break;
                case 2:
                    TitleService.grantTitle(chara, TitleConst.TITLE_YUEKA, "位列仙班·道法自然");
                    break;
                case 3:
                    TitleService.grantTitle(chara, TitleConst.TITLE_YUEKA, "位列仙班·大道无穷");
                    break;
                default:
                    break;
            }
