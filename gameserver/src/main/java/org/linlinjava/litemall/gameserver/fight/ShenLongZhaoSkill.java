...
/**
 * 神龙罩
 * 该法术属于战斗技能，只能在战斗中使用，使用后，被施用对象在一定回合数内抵御一定伤害的物理攻击。
 * 说明：
 ...
 */
public class ShenLongZhaoSkill extends FightRoundSkill {
    /**
     * 可抵御的最大伤害//TODO
     */
    private int leftHp = 20000;
    /**
     * 可抵御的最大次数//TODO
     */
    private int defNum = 1;

    public ShenLongZhaoSkill() {
    }
    public ShenLongZhaoSkill(FightObject buffObject, int removeRound, FightContainer fightContainer) {
    ...
    public List<FightResult> doSkill(FightContainer fightContainer, FightRequest fightRequest, JiNeng jiNeng) {
        ...
        for(var8 = targetList.iterator(); var8.hasNext(); ) {
            ...
            that = new ShenLongZhaoSkill(fightObject, jiNeng.skillRound, fightContainer);
    ...
    public int reduceHp(int reduceHp){
        ...
        if(leftHp >reduceHp){
            leftHp = leftHp -reduceHp;
            reduceHp = 0;
        }else {
            reduceHp = reduceHp- leftHp;
            leftHp = 0;
