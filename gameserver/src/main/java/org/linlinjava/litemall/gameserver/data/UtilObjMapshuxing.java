...
/* 681 */     objectObjectHashMap.put("max_life", Integer.valueOf(obj1.max_life));
/* 682 */     objectObjectHashMap.put("def", Integer.valueOf(obj1.def));
/* 683 */     objectObjectHashMap.put("max_mana", Integer.valueOf(obj1.max_mana));
/* 684 */     objectObjectHashMap.put("dex", Integer.valueOf(obj1.dex));
/* 685 */     objectObjectHashMap.put("skill", Integer.valueOf(obj1.skill));
/* 686 */     objectObjectHashMap.put("penetrate", Integer.valueOf(obj1.penetrate));
/* 687 */     objectObjectHashMap.put("polar_point", Integer.valueOf(obj1.polar_point));
/* 688 */     objectObjectHashMap.put("metal", Integer.valueOf(obj1.metal));
/* 689 */     objectObjectHashMap.put("stamina", Integer.valueOf(obj1.stamina));
/* 690 */     objectObjectHashMap.put("type", Integer.valueOf(obj1.type));
/* 691 */     objectObjectHashMap.put("durability", Integer.valueOf(obj1.durability));
/* 692 */     objectObjectHashMap.put("phy_power", Integer.valueOf(obj1.phy_power));
/* 693 */     objectObjectHashMap.put("mag_power", Integer.valueOf(obj1.mag_power));
/* 694 */     objectObjectHashMap.put("life", Integer.valueOf(obj1.life));
/* 695 */     objectObjectHashMap.put("speed", Integer.valueOf(obj1.speed));
/* 696 */     objectObjectHashMap.put("accurate", Integer.valueOf(obj1.accurate));
/* 697 */     objectObjectHashMap.put("mana", Integer.valueOf(obj1.mana));
/* 698 */     objectObjectHashMap.put("parry", Integer.valueOf(obj1.parry));
/* 699 */     objectObjectHashMap.put("wiz", Integer.valueOf(obj1.wiz));
/* 700 */     objectObjectHashMap.put("shape", Integer.valueOf(obj1.shape));
/* 701 */     objectObjectHashMap.put("pot", Integer.valueOf(obj1.pot));
/* 702 */     objectObjectHashMap.put("loyalty", Integer.valueOf(obj1.loyalty));
/* 703 */     objectObjectHashMap.put("resist_wood", Integer.valueOf(obj1.resist_wood));
/* 704 */     objectObjectHashMap.put("resist_water", Integer.valueOf(obj1.resist_water));
/* 705 */     objectObjectHashMap.put("resist_fire", Integer.valueOf(obj1.resist_fire));
/* 706 */     objectObjectHashMap.put("resist_earth", Integer.valueOf(obj1.resist_earth));
/* 707 */     objectObjectHashMap.put("exp_to_next_level", Integer.valueOf(obj1.exp_to_next_level));
/* 708 */     objectObjectHashMap.put("resist_frozen", Integer.valueOf(obj1.resist_frozen));
/* 709 */     objectObjectHashMap.put("resist_sleep", Integer.valueOf(obj1.resist_sleep));
/* 710 */     objectObjectHashMap.put("resist_forgotten", Integer.valueOf(obj1.resist_forgotten));
/* 711 */     objectObjectHashMap.put("resist_confusion", Integer.valueOf(obj1.resist_confusion));
/* 712 */     objectObjectHashMap.put("longevity", Integer.valueOf(obj1.longevity));
/* 713 */     objectObjectHashMap.put("martial", Integer.valueOf(obj1.martial));
/* 714 */     objectObjectHashMap.put("resist_point", Integer.valueOf(obj1.resist_point));
/* 715 */     objectObjectHashMap.put("intimacy", Integer.valueOf(obj1.intimacy));
/* 716 */     objectObjectHashMap.put("last_mon_martial", Integer.valueOf(obj1.last_mon_martial));
/* 717 */     objectObjectHashMap.put("mon_tao_rank", Integer.valueOf(obj1.mon_tao_rank));
/* 718 */     objectObjectHashMap.put("double_hit", Integer.valueOf(obj1.double_hit));
/* 719 */     objectObjectHashMap.put("resist_poison", Integer.valueOf(obj1.resist_poison));
/* 720 */     objectObjectHashMap.put("passive_mode", Integer.valueOf(obj1.passive_mode));
/* 721 */     objectObjectHashMap.put("pet_mana_shape", Integer.valueOf(obj1.pet_mana_shape));
/* 722 */     objectObjectHashMap.put("pet_speed_shape", Integer.valueOf(obj1.pet_speed_shape));
/* 723 */     objectObjectHashMap.put("pet_phy_shape", Integer.valueOf(obj1.pet_phy_shape));
/* 724 */     objectObjectHashMap.put("pet_mag_shape", Integer.valueOf(obj1.pet_mag_shape));
/* 725 */     objectObjectHashMap.put("rank", Integer.valueOf(obj1.rank));
/* 726 */     objectObjectHashMap.put("pet_upgraded", Integer.valueOf(obj1.pet_upgraded));
/* 727 */     objectObjectHashMap.put("party_stage_party_name", Integer.valueOf(obj1.party_stage_party_name));
/* 728 */     objectObjectHashMap.put("left_time_to_delete", Integer.valueOf(obj1.left_time_to_delete));
/* 729 */     objectObjectHashMap.put("extra_mana", Integer.valueOf(obj1.extra_mana));
/* 730 */     objectObjectHashMap.put("have_coin_pwd", Integer.valueOf(obj1.have_coin_pwd));
/* 731 */     objectObjectHashMap.put("mag_rebuild_level", Integer.valueOf(obj1.mag_rebuild_level));
/* 732 */     objectObjectHashMap.put("raw_name", Integer.valueOf(obj1.raw_name));
/* 733 */     objectObjectHashMap.put("suit_light_effect", Integer.valueOf(obj1.suit_light_effect));
/* 734 */     objectObjectHashMap.put("mag_rebuild_rate", Integer.valueOf(obj1.mag_rebuild_rate));
/* 735 */     objectObjectHashMap.put("life_add_temp", Integer.valueOf(obj1.life_add_temp));
/* 736 */     objectObjectHashMap.put("mag_rebuild_add", Integer.valueOf(obj1.mag_rebuild_add));
/* 737 */     objectObjectHashMap.put("pet_life_shape_temp", Integer.valueOf(obj1.pet_life_shape_temp));
/* 738 */     objectObjectHashMap.put("pet_mana_shape_temp", Integer.valueOf(obj1.pet_mana_shape_temp));
/* 739 */     objectObjectHashMap.put("pet_speed_shape_temp", Integer.valueOf(obj1.pet_speed_shape_temp));
/* 740 */     objectObjectHashMap.put("pet_phy_shape_temp", Integer.valueOf(obj1.pet_phy_shape_temp));
/* 741 */     objectObjectHashMap.put("pet_mag_shape_temp", Integer.valueOf(obj1.pet_mag_shape_temp));
/* 742 */     objectObjectHashMap.put("evolve_degree", Integer.valueOf(obj1.evolve_degree));
/* 743 */     objectObjectHashMap.put("mana_add_temp", Integer.valueOf(obj1.mana_add_temp));
/* 744 */     objectObjectHashMap.put("phy_power_add_temp", Integer.valueOf(obj1.phy_power_add_temp));
/* 745 */     objectObjectHashMap.put("def_add_temp", Integer.valueOf(obj1.def_add_temp));
/* 746 */     objectObjectHashMap.put("mag_power_add_temp", Integer.valueOf(obj1.mag_power_add_temp));
/* 747 */     objectObjectHashMap.put("speed_add_temp", Integer.valueOf(obj1.speed_add_temp));
/* 748 */     objectObjectHashMap.put("shuadaojiji_rulvling", Integer.valueOf(obj1.shuadaojiji_rulvling));
/* 749 */     objectObjectHashMap.put("recognize_recognized", Integer.valueOf(obj1.recognize_recognized));
/* 750 */     objectObjectHashMap.put("attrib", Integer.valueOf(obj1.attrib));
/* 751 */     objectObjectHashMap.put("enchant_nimbus", Integer.valueOf(obj1.enchant_nimbus));
/* 752 */     objectObjectHashMap.put("max_enchant_nimbus", Integer.valueOf(obj1.max_enchant_nimbus));
/* 753 */     objectObjectHashMap.put("card_type", Integer.valueOf(obj1.card_type));
/* 754 */     objectObjectHashMap.put("eclosion_nimbus", Integer.valueOf(obj1.eclosion_nimbus));
/* 755 */     objectObjectHashMap.put("max_eclosion_nimbus", Integer.valueOf(obj1.max_eclosion_nimbus));
/* 756 */     objectObjectHashMap.put("status_all_resist_except_add", Integer.valueOf(obj1.status_all_resist_except_add));
/* 757 */     objectObjectHashMap.put("status_yanchuan_shenjiao", Integer.valueOf(obj1.status_yanchuan_shenjiao));
/* 758 */     objectObjectHashMap.put("insider_level", obj1.insider_level);
/* 759 */     objectObjectHashMap.put("mana_effect", Integer.valueOf(obj1.mana_effect));
/* 760 */     objectObjectHashMap.put("attack_effect", Integer.valueOf(obj1.attack_effect));
/* 761 */     objectObjectHashMap.put("phy_effect", Integer.valueOf(obj1.phy_effect));
/* 762 */     objectObjectHashMap.put("mag_effect", Integer.valueOf(obj1.mag_effect));
/* 763 */     objectObjectHashMap.put("phy_absorb", Integer.valueOf(obj1.phy_absorb));
/* 764 */     objectObjectHashMap.put("extra_mana_effect", Integer.valueOf(obj1.extra_mana_effect));
/* 765 */     objectObjectHashMap.put("extra_mag_effect", Integer.valueOf(obj1.extra_mag_effect));
/* 766 */     objectObjectHashMap.put("extra_phy_effect", Integer.valueOf(obj1.extra_phy_effect));
/* 767 */     objectObjectHashMap.put("extra_speed_effect", Integer.valueOf(obj1.extra_speed_effect));
/* 768 */     objectObjectHashMap.put("morph_life_times", Integer.valueOf(obj1.morph_life_times));
/* 769 */     objectObjectHashMap.put("morph_mana_times", Integer.valueOf(obj1.morph_mana_times));
/* 770 */     objectObjectHashMap.put("morph_speed_times", Integer.valueOf(obj1.morph_speed_times));
/* 771 */     objectObjectHashMap.put("morph_phy_times", Integer.valueOf(obj1.morph_phy_times));
/* 772 */     objectObjectHashMap.put("morph_mag_times", Integer.valueOf(obj1.morph_mag_times));
/* 773 */     objectObjectHashMap.put("morph_life_stat", Integer.valueOf(obj1.morph_life_stat));
/* 774 */     objectObjectHashMap.put("morph_mana_stat", Integer.valueOf(obj1.morph_mana_stat));
/* 775 */     objectObjectHashMap.put("morph_speed_stat", Integer.valueOf(obj1.morph_speed_stat));
/* 776 */     objectObjectHashMap.put("morph_phy_stat", Integer.valueOf(obj1.morph_phy_stat));
/* 777 */     objectObjectHashMap.put("morph_mag_stat", Integer.valueOf(obj1.morph_mag_stat));
/* 778 */     objectObjectHashMap.put("free_unlock_exp_times", Integer.valueOf(obj1.free_unlock_exp_times));
/* 779 */     objectObjectHashMap.put("mount_attribmove_speed", Integer.valueOf(obj1.mount_attribmove_speed));
/* 780 */     objectObjectHashMap.put("capacity_level", Integer.valueOf(obj1.capacity_level));
/* 781 */     objectObjectHashMap.put("hide_mount", Integer.valueOf(obj1.hide_mount));
/* 782 */     objectObjectHashMap.put("equip_perfect_percent", Integer.valueOf(obj1.equip_perfect_percent));
/* 783 */     objectObjectHashMap.put("deadline", Integer.valueOf(obj1.deadline));
/* 784 */     objectObjectHashMap.put("merge_rate", Integer.valueOf(obj1.merge_rate));
/* 785 */     objectObjectHashMap.put("dunwu_rate", Integer.valueOf(obj1.dunwu_rate));
/* 786 */     objectObjectHashMap.put("pet_anger", Integer.valueOf(obj1.pet_anger));
/* 787 */     objectObjectHashMap.put("status_huanbing_zhiji", Integer.valueOf(obj1.status_huanbing_zhiji));
/* 788 */     objectObjectHashMap.put("gm_attribsmax_life", Integer.valueOf(obj1.gm_attribsmax_life));
/* 789 */     objectObjectHashMap.put("gm_attribsmax_mana", Integer.valueOf(obj1.gm_attribsmax_mana));
/* 790 */     objectObjectHashMap.put("gm_attribsphy_power", Integer.valueOf(obj1.gm_attribsphy_power));
/* 791 */     objectObjectHashMap.put("gm_attribsmag_power", Integer.valueOf(obj1.gm_attribsmag_power));
/* 792 */     objectObjectHashMap.put("gm_attribsdef", Integer.valueOf(obj1.gm_attribsdef));
/* 793 */     objectObjectHashMap.put("gm_attribsspeed", Integer.valueOf(obj1.gm_attribsspeed));
/* 794 */     objectObjectHashMap.put("limit_use_time", Integer.valueOf(obj1.limit_use_time));
/* 795 */     objectObjectHashMap.put("mag_power_without_intimacy", Integer.valueOf(obj1.mag_power_without_intimacy));
/* 796 */     objectObjectHashMap.put("def_without_intimacy", Integer.valueOf(obj1.def_without_intimacy));
/* 797 */     objectObjectHashMap.put("origin_intimacy", Integer.valueOf(obj1.origin_intimacy));
/* 798 */     objectObjectHashMap.put("douchong_rank", Integer.valueOf(obj1.douchong_rank));
/* 799 */     objectObjectHashMap.put("fasion_id", Integer.valueOf(obj1.fasion_id));
/* 800 */     objectObjectHashMap.put("fasion_visible", Integer.valueOf(obj1.fasion_visible));
/* 801 */     objectObjectHashMap.put("auto_fight", obj1.auto_fight);
/* 802 */     objectObjectHashMap.put("suit_polar", obj1.suit_polar);
/* 803 */     objectObjectHashMap.put("all_polar", Integer.valueOf(obj1.all_polar));
