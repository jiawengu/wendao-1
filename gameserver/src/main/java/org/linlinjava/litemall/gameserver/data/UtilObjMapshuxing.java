...
/* 148 */     objectObjectHashMap.put("gid", obj1.iid_str);
/* 149 */     objectObjectHashMap.put("level", Integer.valueOf(obj1.skill));
/* 150 */     objectObjectHashMap.put("name", obj1.str);
/* 151 */     objectObjectHashMap.put("gender", Integer.valueOf(obj1.master));
/* 152 */     objectObjectHashMap.put("polar", Integer.valueOf(obj1.metal));
/* 153 */     objectObjectHashMap.put("family", obj1.req_str);
/* 154 */     objectObjectHashMap.put("portrait", Integer.valueOf(obj1.passive_mode));
/* 155 */     objectObjectHashMap.put("party/name", obj1.party_contrib);
...
/* 448 */     objectObjectHashMap.put("attrib", Integer.valueOf(obj1.value));
/* 449 */     objectObjectHashMap.put("item_type", Integer.valueOf(obj1.total_score));
/* 450 */     objectObjectHashMap.put("icon", Integer.valueOf(obj1.type));
/* 451 */     objectObjectHashMap.put("value", Integer.valueOf(obj1.rebuild_level));
/* 452 */     objectObjectHashMap.put("name", obj1.str);

/* 453 */     objectObjectHashMap.put("iid_str", obj1.auto_fight);

			  objectObjectHashMap.put("speed", Integer.valueOf(obj1.parry));
/* 454 */     objectObjectHashMap.put("color", obj1.quality);
/* 455 */     objectObjectHashMap.put("item_unique", Integer.valueOf(obj1.damage_sel_rate));
/* 456 */     objectObjectHashMap.put("gift", Integer.valueOf(obj1.recognize_recognized));

/* 457 */     objectObjectHashMap.put("amount", Integer.valueOf(obj1.owner_id));

/* 458 */     objectObjectHashMap.put("equip_perfect_percent", Integer.valueOf(obj1.dunwu_times));
/* 459 */     objectObjectHashMap.put("req_level", Integer.valueOf(obj1.attrib));
/* 460 */     objectObjectHashMap.put("suit_enabled", Integer.valueOf(obj1.gift));
/* 461 */     objectObjectHashMap.put("party_contrib", Integer.valueOf(obj1.nick));
/* 462 */     objectObjectHashMap.put("evolve_degree", Integer.valueOf(obj1.power));
/* 463 */     objectObjectHashMap.put("prop2_color", Integer.valueOf(obj1.wrestlescore));
/* 464 */     objectObjectHashMap.put("level", Integer.valueOf(obj1.skill));
/* 465 */     objectObjectHashMap.put("degree_32", Integer.valueOf(obj1.store_exp));
/* 466 */     objectObjectHashMap.put("polar", Integer.valueOf(obj1.metal));
/* 467 */     objectObjectHashMap.put("equip_type", Integer.valueOf(obj1.amount));
/* 468 */     objectObjectHashMap.put("rebuild_level", Integer.valueOf(obj1.color));
/* 469 */     objectObjectHashMap.put("suit_level", Integer.valueOf(obj1.suit_degree));
/* 470 */     objectObjectHashMap.put("recognize_recognized", Integer.valueOf(obj1.party_stage_party_name));
/* 471 */     objectObjectHashMap.put("evolve_level", Integer.valueOf(obj1.mailing_item_times));
/* 472 */     objectObjectHashMap.put("suit_polar", Integer.valueOf(obj1.suit_enabled));
/* 473 */     objectObjectHashMap.put("unidentified", Integer.valueOf(obj1.degree_32));
/* 474 */     objectObjectHashMap.put("gender", Integer.valueOf(obj1.master));
/* 475 */     objectObjectHashMap.put("transform_num", Integer.valueOf(obj1.transform_cool_ti));
/* 476 */     objectObjectHashMap.put("nimbus", Integer.valueOf(obj1.silver_coin));
/* 477 */     objectObjectHashMap.put("extra_skill_level", Integer.valueOf(obj1.diandqk_frozen_round));
/* 478 */     objectObjectHashMap.put("item_polar", Integer.valueOf(obj1.shuadao_ziqihongmeng));
/* 479 */     objectObjectHashMap.put("type", Integer.valueOf(obj1.durability));
/* 480 */     objectObjectHashMap.put("upgrade_type", Integer.valueOf(obj1.add_pet_exp));
/* 481 */     objectObjectHashMap.put("chat_floor", obj1.alias);
/* 482 */     objectObjectHashMap.put("fasion_type", Integer.valueOf(obj1.food_num));
/* 483 */     objectObjectHashMap.put("deadline", Integer.valueOf(obj1.merge_rate));
/* 484 */     objectObjectHashMap.put("limit_use_time", Integer.valueOf(obj1.fasion_type));
/* 485 */     objectObjectHashMap.put("locked", Integer.valueOf(obj1.pet_upgraded));
/* 486 */     objectObjectHashMap.put("reputation", Integer.valueOf(obj1.couple));
/* 487 */     objectObjectHashMap.put("intimacy", Integer.valueOf(obj1.shape));
/* 488 */     objectObjectHashMap.put("exp", Integer.valueOf(obj1.pot));
/* 489 */     objectObjectHashMap.put("exp_to_next_level", Integer.valueOf(obj1.resist_poison));
/* 490 */     objectObjectHashMap.put("extra_desc", obj1.phy_rebuild_level);
/* 491 */     objectObjectHashMap.put("durability", Integer.valueOf(obj1.max_durability));
...
/* 691 */     objectObjectHashMap.put("type", Integer.valueOf(obj1.durability));
/* 692 */     objectObjectHashMap.put("str", Integer.valueOf(obj1.phy_power));
/* 693 */     objectObjectHashMap.put("wiz", Integer.valueOf(obj1.mag_power));
/* 694 */     objectObjectHashMap.put("con", Integer.valueOf(obj1.life));
/* 695 */     objectObjectHashMap.put("dex", Integer.valueOf(obj1.speed));
/* 696 */     objectObjectHashMap.put("phy_power", Integer.valueOf(obj1.accurate));
/* 697 */     objectObjectHashMap.put("mag_power", Integer.valueOf(obj1.mana));
/* 698 */     objectObjectHashMap.put("speed", Integer.valueOf(obj1.parry));
/* 699 */     objectObjectHashMap.put("def", Integer.valueOf(obj1.wiz));
/* 700 */     objectObjectHashMap.put("intimacy", Integer.valueOf(obj1.shape));
/* 701 */     objectObjectHashMap.put("exp", Integer.valueOf(obj1.pot));
/* 702 */     objectObjectHashMap.put("resist_point", Integer.valueOf(obj1.loyalty));
/* 703 */     objectObjectHashMap.put("resist_metal", Integer.valueOf(obj1.resist_wood));
/* 704 */     objectObjectHashMap.put("resist_wood", Integer.valueOf(obj1.resist_water));
/* 705 */     objectObjectHashMap.put("resist_water", Integer.valueOf(obj1.resist_fire));
/* 706 */     objectObjectHashMap.put("resist_fire", Integer.valueOf(obj1.resist_earth));
/* 707 */     objectObjectHashMap.put("resist_earth", Integer.valueOf(obj1.exp_to_next_level));
/* 708 */     objectObjectHashMap.put("resist_poison", Integer.valueOf(obj1.resist_frozen));
/* 709 */     objectObjectHashMap.put("resist_frozen", Integer.valueOf(obj1.resist_sleep));
/* 710 */     objectObjectHashMap.put("resist_sleep", Integer.valueOf(obj1.resist_forgotten));
/* 711 */     objectObjectHashMap.put("resist_forgotten", Integer.valueOf(obj1.resist_confusion));
/* 712 */     objectObjectHashMap.put("resist_confusion", Integer.valueOf(obj1.longevity));
/* 713 */     objectObjectHashMap.put("longevity", Integer.valueOf(obj1.martial));
/* 714 */     objectObjectHashMap.put("shape", Integer.valueOf(obj1.resist_point));
/* 715 */     objectObjectHashMap.put("martial", Integer.valueOf(obj1.intimacy));
/* 716 */     objectObjectHashMap.put("mon_martial", Integer.valueOf(obj1.last_mon_martial));
/* 717 */     objectObjectHashMap.put("last_mon_martial", Integer.valueOf(obj1.mon_tao_rank));
/* 718 */     objectObjectHashMap.put("loyalty", Integer.valueOf(obj1.double_hit));
/* 719 */     objectObjectHashMap.put("exp_to_next_level", Integer.valueOf(obj1.resist_poison));
/* 720 */     objectObjectHashMap.put("portrait", Integer.valueOf(obj1.passive_mode));
/* 721 */     objectObjectHashMap.put("pet_life_shape", Integer.valueOf(obj1.pet_mana_shape));
/* 722 */     objectObjectHashMap.put("pet_mana_shape", Integer.valueOf(obj1.pet_speed_shape));
/* 723 */     objectObjectHashMap.put("pet_speed_shape", Integer.valueOf(obj1.pet_phy_shape));
/* 724 */     objectObjectHashMap.put("pet_phy_shape", Integer.valueOf(obj1.pet_mag_shape));
/* 725 */     objectObjectHashMap.put("pet_mag_shape", Integer.valueOf(obj1.rank));
/* 726 */     objectObjectHashMap.put("locked", Integer.valueOf(obj1.pet_upgraded));
/* 727 */     objectObjectHashMap.put("recognize_recognized", Integer.valueOf(obj1.party_stage_party_name));
/* 728 */     objectObjectHashMap.put("pet_upgraded", Integer.valueOf(obj1.left_time_to_delete));
/* 729 */     objectObjectHashMap.put("extra_life", Integer.valueOf(obj1.extra_mana));
/* 730 */     objectObjectHashMap.put("extra_mana", Integer.valueOf(obj1.have_coin_pwd));
/* 731 */     objectObjectHashMap.put("phy_rebuild_level", Integer.valueOf(obj1.mag_rebuild_level));
/* 732 */     objectObjectHashMap.put("mag_rebuild_level", Integer.valueOf(obj1.raw_name));
/* 733 */     objectObjectHashMap.put("mount_type", Integer.valueOf(obj1.suit_light_effect));
/* 734 */     objectObjectHashMap.put("phy_rebuild_rate", Integer.valueOf(obj1.mag_rebuild_rate));
/* 735 */     objectObjectHashMap.put("mag_rebuild_rate", Integer.valueOf(obj1.life_add_temp));
/* 736 */     objectObjectHashMap.put("phy_rebuild_add", Integer.valueOf(obj1.mag_rebuild_add));
/* 737 */     objectObjectHashMap.put("mag_rebuild_add", Integer.valueOf(obj1.pet_life_shape_temp));
/* 738 */     objectObjectHashMap.put("pet_life_shape_temp", Integer.valueOf(obj1.pet_mana_shape_temp));
/* 739 */     objectObjectHashMap.put("pet_mana_shape_temp", Integer.valueOf(obj1.pet_speed_shape_temp));
/* 740 */     objectObjectHashMap.put("pet_speed_shape_temp", Integer.valueOf(obj1.pet_phy_shape_temp));
/* 741 */     objectObjectHashMap.put("pet_phy_shape_temp", Integer.valueOf(obj1.pet_mag_shape_temp));
/* 742 */     objectObjectHashMap.put("pet_mag_shape_temp", Integer.valueOf(obj1.evolve_degree));
/* 743 */     objectObjectHashMap.put("life_add_temp", Integer.valueOf(obj1.mana_add_temp));
/* 744 */     objectObjectHashMap.put("mana_add_temp", Integer.valueOf(obj1.phy_power_add_temp));
/* 745 */     objectObjectHashMap.put("speed_add_temp", Integer.valueOf(obj1.def_add_temp));
/* 746 */     objectObjectHashMap.put("phy_power_add_temp", Integer.valueOf(obj1.mag_power_add_temp));
/* 747 */     objectObjectHashMap.put("mag_power_add_temp", Integer.valueOf(obj1.speed_add_temp));
/* 748 */     objectObjectHashMap.put("lock_exp", Integer.valueOf(obj1.shuadaojiji_rulvling));
/* 749 */     objectObjectHashMap.put("gift", Integer.valueOf(obj1.recognize_recognized));
/* 750 */     objectObjectHashMap.put("req_level", Integer.valueOf(obj1.attrib));
/* 751 */     objectObjectHashMap.put("enchant", Integer.valueOf(obj1.enchant_nimbus));
/* 752 */     objectObjectHashMap.put("enchant_nimbus", Integer.valueOf(obj1.max_enchant_nimbus));
/* 753 */     objectObjectHashMap.put("max_enchant_nimbus", Integer.valueOf(obj1.card_type));
/* 754 */     objectObjectHashMap.put("eclosion", Integer.valueOf(obj1.eclosion_nimbus));
/* 755 */     objectObjectHashMap.put("eclosion_nimbus", Integer.valueOf(obj1.max_eclosion_nimbus));
/* 756 */     objectObjectHashMap.put("max_eclosion_nimbus", Integer.valueOf(obj1.status_all_resist_except_add));
/* 757 */     objectObjectHashMap.put("eclosion_stage", Integer.valueOf(obj1.status_yanchuan_shenjiao));
/* 758 */     objectObjectHashMap.put("evolve", obj1.insider_level);
/* 759 */     objectObjectHashMap.put("life_effect", Integer.valueOf(obj1.mana_effect));
/* 760 */     objectObjectHashMap.put("mana_effect", Integer.valueOf(obj1.attack_effect));
/* 761 */     objectObjectHashMap.put("speed_effect", Integer.valueOf(obj1.phy_effect));
/* 762 */     objectObjectHashMap.put("phy_effect", Integer.valueOf(obj1.mag_effect));
/* 763 */     objectObjectHashMap.put("mag_effect", Integer.valueOf(obj1.phy_absorb));
/* 764 */     objectObjectHashMap.put("extra_life_effect", Integer.valueOf(obj1.extra_mana_effect));
/* 765 */     objectObjectHashMap.put("extra_mana_effect", Integer.valueOf(obj1.extra_mag_effect));
/* 766 */     objectObjectHashMap.put("extra_mag_effect", Integer.valueOf(obj1.extra_phy_effect));
/* 767 */     objectObjectHashMap.put("extra_phy_effect", Integer.valueOf(obj1.extra_speed_effect));
/* 768 */     objectObjectHashMap.put("extra_speed_effect", Integer.valueOf(obj1.morph_life_times));
/* 769 */     objectObjectHashMap.put("morph_life_times", Integer.valueOf(obj1.morph_mana_times));
/* 770 */     objectObjectHashMap.put("morph_mana_times", Integer.valueOf(obj1.morph_speed_times));
/* 771 */     objectObjectHashMap.put("morph_speed_times", Integer.valueOf(obj1.morph_phy_times));
/* 772 */     objectObjectHashMap.put("morph_phy_times", Integer.valueOf(obj1.morph_mag_times));
/* 773 */     objectObjectHashMap.put("morph_mag_times", Integer.valueOf(obj1.morph_life_stat));
/* 774 */     objectObjectHashMap.put("morph_life_stat", Integer.valueOf(obj1.morph_mana_stat));
/* 775 */     objectObjectHashMap.put("morph_mana_stat", Integer.valueOf(obj1.morph_speed_stat));
/* 776 */     objectObjectHashMap.put("morph_speed_stat", Integer.valueOf(obj1.morph_phy_stat));
/* 777 */     objectObjectHashMap.put("morph_phy_stat", Integer.valueOf(obj1.morph_mag_stat));
/* 778 */     objectObjectHashMap.put("morph_mag_stat", Integer.valueOf(obj1.free_unlock_exp_times));
/* 779 */     objectObjectHashMap.put("mount_attrib_end_time", Integer.valueOf(obj1.mount_attribmove_speed));
/* 780 */     objectObjectHashMap.put("mount_attribmove_speed", Integer.valueOf(obj1.capacity_level));
/* 781 */     objectObjectHashMap.put("capacity_level", Integer.valueOf(obj1.hide_mount));
/* 782 */     objectObjectHashMap.put("merge_rate", Integer.valueOf(obj1.equip_perfect_percent));
/* 783 */     objectObjectHashMap.put("hide_mount", Integer.valueOf(obj1.deadline));
/* 784 */     objectObjectHashMap.put("deadline", Integer.valueOf(obj1.merge_rate));
/* 785 */     objectObjectHashMap.put("dunwu_times", Integer.valueOf(obj1.dunwu_rate));
/* 786 */     objectObjectHashMap.put("dunwu_rate", Integer.valueOf(obj1.pet_anger));
/* 787 */     objectObjectHashMap.put("pet_anger", Integer.valueOf(obj1.status_huanbing_zhiji));
/* 788 */     objectObjectHashMap.put("gm_attribsmax_mana", Integer.valueOf(obj1.gm_attribsmax_life));
/* 789 */     objectObjectHashMap.put("gm_attribsphy_power", Integer.valueOf(obj1.gm_attribsmax_mana));
/* 790 */     objectObjectHashMap.put("gm_attribsmag_power", Integer.valueOf(obj1.gm_attribsphy_power));
/* 791 */     objectObjectHashMap.put("gm_attribsdef", Integer.valueOf(obj1.gm_attribsmag_power));
/* 792 */     objectObjectHashMap.put("gm_attribsspeed", Integer.valueOf(obj1.gm_attribsdef));
/* 793 */     objectObjectHashMap.put("marriage_couple_gid", Integer.valueOf(obj1.gm_attribsspeed));
/* 794 */     objectObjectHashMap.put("has_upgraded", Integer.valueOf(obj1.limit_use_time));
/* 795 */     objectObjectHashMap.put("phy_power_without_intimacy", Integer.valueOf(obj1.mag_power_without_intimacy));
/* 796 */     objectObjectHashMap.put("mag_power_without_intimacy", Integer.valueOf(obj1.def_without_intimacy));
/* 797 */     objectObjectHashMap.put("def_without_intimacy", Integer.valueOf(obj1.origin_intimacy));
/* 798 */     objectObjectHashMap.put("origin_intimacy", Integer.valueOf(obj1.douchong_rank));
/* 799 */     objectObjectHashMap.put("dye_icon", Integer.valueOf(obj1.fasion_id));
/* 800 */     objectObjectHashMap.put("fasion_id", Integer.valueOf(obj1.fasion_visible));
/* 801 */     objectObjectHashMap.put("iid_str", obj1.auto_fight);
/* 802 */     objectObjectHashMap.put("raw_name", obj1.suit_polar);
/* 803 */     objectObjectHashMap.put("all_attrib", Integer.valueOf(obj1.all_polar));
/* 804 */     objectObjectHashMap.put("upgrade_immortal", Integer.valueOf(obj1.upgrade_magic));
/* 805 */     objectObjectHashMap.put("upgrade_magic", Integer.valueOf(obj1.upgrade_total));
/* 806 */     objectObjectHashMap.put("nimbus", Integer.valueOf(obj1.silver_coin));
...
/* 827 */     objectObjectHashMap.put("name", obj1.str);
/* 828 */     objectObjectHashMap.put("metal", Integer.valueOf(obj1.wood));
/* 829 */     objectObjectHashMap.put("wood", Integer.valueOf(obj1.water));
/* 830 */     objectObjectHashMap.put("water", Integer.valueOf(obj1.fire));
/* 831 */     objectObjectHashMap.put("fire", Integer.valueOf(obj1.earth));
/* 832 */     objectObjectHashMap.put("earth", Integer.valueOf(obj1.resist_metal));
/* 833 */     objectObjectHashMap.put("level", Integer.valueOf(obj1.skill));
/* 834 */     objectObjectHashMap.put("icon", Integer.valueOf(obj1.type));
/* 835 */     objectObjectHashMap.put("intimacy", Integer.valueOf(obj1.shape));
/* 836 */     objectObjectHashMap.put("combat_guard", Integer.valueOf(obj1.nil));
/* 837 */     objectObjectHashMap.put("rank", Integer.valueOf(obj1.penetrate));
/* 838 */     objectObjectHashMap.put("polar", Integer.valueOf(obj1.metal));
/* 839 */     objectObjectHashMap.put("use_skill_d", Integer.valueOf(obj1.max_degree));
/* 840 */     objectObjectHashMap.put("rebuild_level", Integer.valueOf(obj1.color));
/* 841 */     objectObjectHashMap.put("degree", Integer.valueOf(obj1.exp));
/* 842 */     objectObjectHashMap.put("degree_32", Integer.valueOf(obj1.store_exp));
/* 843 */     objectObjectHashMap.put("combat_guard_index", Integer.valueOf(obj1.salary));
/* 844 */     objectObjectHashMap.put("wiz", Integer.valueOf(obj1.mag_power));
/* 845 */     objectObjectHashMap.put("mag_power", Integer.valueOf(obj1.mana));
/* 846 */     objectObjectHashMap.put("str", Integer.valueOf(obj1.phy_power));
/* 847 */     objectObjectHashMap.put("phy_power", Integer.valueOf(obj1.accurate));
/* 848 */     objectObjectHashMap.put("raw_name", obj1.suit_polar);
/* 849 */     objectObjectHashMap.put("con", Integer.valueOf(obj1.life));
/* 850 */     objectObjectHashMap.put("speed", Integer.valueOf(obj1.parry));
/* 851 */     objectObjectHashMap.put("max_life", Integer.valueOf(obj1.def));
/* 852 */     objectObjectHashMap.put("def", Integer.valueOf(obj1.wiz));
/* 853 */     objectObjectHashMap.put("life", Integer.valueOf(obj1.max_life));
/* 854 */     objectObjectHashMap.put("dex", Integer.valueOf(obj1.speed));
...
/* 872 */     objectObjectHashMap.put("str", Integer.valueOf(obj1.phy_power));
/* 873 */     objectObjectHashMap.put("wiz", Integer.valueOf(obj1.mag_power));
/* 874 */     objectObjectHashMap.put("dex", Integer.valueOf(obj1.speed));
/* 875 */     objectObjectHashMap.put("con", Integer.valueOf(obj1.life));
/* 876 */     objectObjectHashMap.put("power", Integer.valueOf(obj1.skill_low_cost));
/* 877 */     objectObjectHashMap.put("all_skill", Integer.valueOf(obj1.mstunt_rate));
/* 878 */     objectObjectHashMap.put("metal", Integer.valueOf(obj1.wood));
/* 879 */     objectObjectHashMap.put("wood", Integer.valueOf(obj1.water));
/* 880 */     objectObjectHashMap.put("water", Integer.valueOf(obj1.fire));
/* 881 */     objectObjectHashMap.put("fire", Integer.valueOf(obj1.earth));
/* 882 */     objectObjectHashMap.put("earth", Integer.valueOf(obj1.resist_metal));
/* 883 */     objectObjectHashMap.put("stunt_rate", Integer.valueOf(obj1.damage_sel));
/* 884 */     objectObjectHashMap.put("double_hit_rate", Integer.valueOf(obj1.stunt_rate));
/* 885 */     objectObjectHashMap.put("counter_attack_rate", Integer.valueOf(obj1.double_hit_rate));
/* 886 */     objectObjectHashMap.put("ignore_all_resist_except", Integer.valueOf(obj1.release_forgotten));
/* 887 */     objectObjectHashMap.put("ignore_all_resist_polar", Integer.valueOf(obj1.ignore_all_resist_except));
/* 888 */     objectObjectHashMap.put("double_hit", Integer.valueOf(obj1.stunt));
/* 889 */     objectObjectHashMap.put("max_life", Integer.valueOf(obj1.def));
/* 890 */     objectObjectHashMap.put("max_mana", Integer.valueOf(obj1.dex));
/* 891 */     objectObjectHashMap.put("def", Integer.valueOf(obj1.wiz));
/* 892 */     objectObjectHashMap.put("damage_sel", Integer.valueOf(obj1.family));
/* 893 */     objectObjectHashMap.put("counter_attack", Integer.valueOf(obj1.life_recover));
/* 894 */     objectObjectHashMap.put("all_resist_except", Integer.valueOf(obj1.all_skill));
/* 895 */     objectObjectHashMap.put("damage_sel_rate", Integer.valueOf(obj1.portrait));
/* 896 */     objectObjectHashMap.put("resist_poison", Integer.valueOf(obj1.resist_frozen));
/* 897 */     objectObjectHashMap.put("resist_frozen", Integer.valueOf(obj1.resist_sleep));
/* 898 */     objectObjectHashMap.put("resist_sleep", Integer.valueOf(obj1.resist_forgotten));
/* 899 */     objectObjectHashMap.put("resist_forgotten", Integer.valueOf(obj1.resist_confusion));
/* 900 */     objectObjectHashMap.put("resist_confusion", Integer.valueOf(obj1.longevity));
/* 901 */     objectObjectHashMap.put("resist_metal", Integer.valueOf(obj1.resist_wood));
/* 902 */     objectObjectHashMap.put("resist_wood", Integer.valueOf(obj1.resist_water));
/* 903 */     objectObjectHashMap.put("resist_water", Integer.valueOf(obj1.resist_fire));
/* 904 */     objectObjectHashMap.put("resist_fire", Integer.valueOf(obj1.resist_earth));
/* 905 */     objectObjectHashMap.put("resist_earth", Integer.valueOf(obj1.exp_to_next_level));
/* 906 */     objectObjectHashMap.put("all_resist_polar", Integer.valueOf(obj1.all_resist_except));
/* 907 */     objectObjectHashMap.put("phy_power", Integer.valueOf(obj1.accurate));
/* 908 */     objectObjectHashMap.put("mag_power", Integer.valueOf(obj1.mana));
/* 909 */     objectObjectHashMap.put("speed", Integer.valueOf(obj1.parry));
/* 910 */     objectObjectHashMap.put("super_excluse_metal", Integer.valueOf(obj1.super_excluse_wood));
/* 911 */     objectObjectHashMap.put("super_excluse_wood", Integer.valueOf(obj1.super_excluse_water));
/* 912 */     objectObjectHashMap.put("super_excluse_water", Integer.valueOf(obj1.super_excluse_fire));
/* 913 */     objectObjectHashMap.put("super_excluse_fire", Integer.valueOf(obj1.super_excluse_earth));
/* 914 */     objectObjectHashMap.put("super_excluse_earth", Integer.valueOf(obj1.B_skill_low_cost));
/* 915 */     objectObjectHashMap.put("enhanced_metal", Integer.valueOf(obj1.enhanced_wood));
/* 916 */     objectObjectHashMap.put("enhanced_wood", Integer.valueOf(obj1.enhanced_water));
/* 917 */     objectObjectHashMap.put("enhanced_water", Integer.valueOf(obj1.enhanced_fire));
/* 918 */     objectObjectHashMap.put("enhanced_fire", Integer.valueOf(obj1.enhanced_earth));
/* 919 */     objectObjectHashMap.put("enhanced_earth", Integer.valueOf(obj1.mag_dodge));
/* 920 */     objectObjectHashMap.put("enhanced_phy", Integer.valueOf(obj1.ignore_mag_dodge));
/* 921 */     objectObjectHashMap.put("mag_dodge", Integer.valueOf(obj1.jinguang_zhaxian_counter_att_rate));
/* 922 */     objectObjectHashMap.put("B_skill_low_cost", Integer.valueOf(obj1.C_skill_low_cost));
/* 923 */     objectObjectHashMap.put("C_skill_low_cost", Integer.valueOf(obj1.D_skill_low_cost));
/* 924 */     objectObjectHashMap.put("D_skill_low_cost", Integer.valueOf(obj1.super_poison));
/* 925 */     objectObjectHashMap.put("ignore_resist_metal", Integer.valueOf(obj1.ignore_resist_wood));
/* 926 */     objectObjectHashMap.put("ignore_resist_wood", Integer.valueOf(obj1.ignore_resist_water));
/* 927 */     objectObjectHashMap.put("ignore_resist_water", Integer.valueOf(obj1.ignore_resist_fire));
/* 928 */     objectObjectHashMap.put("ignore_resist_fire", Integer.valueOf(obj1.ignore_resist_earth));
/* 929 */     objectObjectHashMap.put("ignore_resist_earth", Integer.valueOf(obj1.ignore_resist_forgotten));
/* 930 */     objectObjectHashMap.put("super_forgotten", Integer.valueOf(obj1.super_confusion));
/* 931 */     objectObjectHashMap.put("super_sleep", Integer.valueOf(obj1.super_sleep));
/* 932 */     objectObjectHashMap.put("super_poison", Integer.valueOf(obj1.enhanced_metal));
/* 933 */     objectObjectHashMap.put("super_sleep", Integer.valueOf(obj1.super_forgotten));
/* 934 */     objectObjectHashMap.put("super_confusion", Integer.valueOf(obj1.super_frozen));
/* 935 */     objectObjectHashMap.put("ignore_resist_poison", Integer.valueOf(obj1.ignore_resist_frozen));
/* 936 */     objectObjectHashMap.put("ignore_resist_frozen", Integer.valueOf(obj1.ignore_resist_sleep));
/* 937 */     objectObjectHashMap.put("ignore_resist_sleep", Integer.valueOf(obj1.ignore_resist_confusion));
/* 938 */     objectObjectHashMap.put("ignore_resist_confusion", Integer.valueOf(obj1.super_excluse_metal));
/* 939 */     objectObjectHashMap.put("ignore_resist_forgotten", Integer.valueOf(obj1.ignore_resist_poison));
/* 940 */     objectObjectHashMap.put("release_confusion", Integer.valueOf(obj1.tao_ex));
/* 941 */     objectObjectHashMap.put("release_sleep", Integer.valueOf(obj1.release_confusion));
/* 942 */     objectObjectHashMap.put("release_frozen", Integer.valueOf(obj1.release_sleep));
/* 943 */     objectObjectHashMap.put("release_poison", Integer.valueOf(obj1.release_frozen));
/* 944 */     objectObjectHashMap.put("release_forgotten", Integer.valueOf(obj1.release_poison));
