...
public class NoviceGiftBagUtils {
    ...
    public static String[] giftBags(int attrib, int sex, int metal) {
        ...
        String[] bag3;
        if (attrib == 10) {
            bag3 = new String[]{"铁枪", "虎爪", "青锋剑", "精铁扇", "流星锤"};
            bag2 = new String[]{"飞凤钗", "绛紫裙"};
            bag = new String[]{"虎爪#装备", "皮帽#装备", "布鞋#装备", "虎皮衣#装备", "驯兽诀#物品"};
            bag[0] = bag3[metal - 1] + "#装备";
            if (sex == 2) {
                bag[1] = bag2[0] + "#装备";
                bag[3] = bag2[1] + "#装备";
            }
            ...
            bag3 = new String[]{"点钢枪", "赤炼爪", "沉香剑", "逍遥扇", "八棱锤"};
            bag2 = new String[]{"碧玉钗", "虹羽衣"};
            bag = new String[]{"赤炼爪#装备", "青铜盔#装备", "马靴#装备", "青铜铠#装备", "纹龙佩#首饰", "青珑挂珠#首饰", "金刚手镯#首饰", "金刚手镯#首饰", "血玲珑#物品", "法玲珑#物品", "代金券#100000"};
            bag[0] = bag3[metal - 1] + "#装备";
            //System.out.println(metal+"  "+bag[0]+"  zzz"+"tttt");
            if (sex == 2) {
                bag[1] = bag2[0] + "#装备";
                bag[3] = bag2[1] + "#装备";
            }
            ...
            bag3 = new String[]{"乌金枪", "残青爪", "飞虹剑", "玉骨扇", "亮银锤"};
            bag2 = new String[]{"蝴蝶钗", "凤暖袍"};
            ...
            bag3 = new String[]{"火焰枪", "阴风爪", "乾元剑", "阴阳扇", "乌金锤"};
            bag2 = new String[]{"金钗", "锦月袄"};
            ...
            bag3 = new String[]{"双头枪", "寒冰刺", "斩妖剑", "凤羽扇", "混元锤"};
            bag2 = new String[]{"珍珠钗", "凝霜衣"};
            ...
            bag3 = new String[]{"寒风枪", "骷髅爪", "昆吾剑", "百花扇", "霹雳锤"};
            bag2 = new String[]{"凤尾钗", "水合袍"};
