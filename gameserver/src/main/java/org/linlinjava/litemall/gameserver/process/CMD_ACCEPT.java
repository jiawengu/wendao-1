...
/*     */ public class CMD_ACCEPT implements org.linlinjava.litemall.gameserver.GameHandler
/*     */ {
...
/*  52 */       GameObjectChar.send(new MSG_FRIEND_UPDATE_PARTIAL(), vo_24505_0);
/*     */       
/*     */ 
...
/*  76 */       GameObjectChar.send(new MSG_FRIEND_UPDATE_PARTIAL(), vo_24505_0);
/*     */       
...
/* 111 */       GameObjectCharMng.getGameObjectChar(chara1.id).sendOne(new MSG_FRIEND_UPDATE_PARTIAL(), vo_24505_0);
/*     */       
